package com.example.kafkauserlocation.aspect.logging;

import com.example.kafkauserlocation.utility.Utility;
...
public class LoggingAspect {
    ...
    @Around("within(com.example.kafkauserlocation.service..*)")
